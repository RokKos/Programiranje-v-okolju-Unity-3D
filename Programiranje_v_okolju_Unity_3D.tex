...
\begin{document}
	...
	\listoffigures 
	%prikaz virov
	%\addcontentsline{toc}{chapter}{Viri in literatura} %dodano v kategorije
	%\bibliographystyle{unsrt} %style prikaza
	%\bibliography{bibliografija} %bib file, ki se includa
